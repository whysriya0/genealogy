  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="container" style={{ padding: '4rem 24px', flex: 1, maxWidth: '800px', margin: '0 auto' }}>
        <h1 style={{ fontSize: '3.5rem', marginBottom: '2rem', fontFamily: 'var(--font-serif)' }}>
          About Vamsha
        </h1>
        
        <div className="glass-panel" style={{ padding: '3rem', fontSize: '1.125rem', lineHeight: 1.8 }}>
          <p style={{ marginBottom: '1.5rem' }}>
            <strong>Vamsha</strong> is a specialized Indian Genealogy Portal designed to accurately capture the deep, complex, and culturally significant relationships found throughout Indian history, mythology, and modern family structures.
          </p>
          
          <h2 style={{ fontSize: '1.5rem', marginTop: '2.5rem', marginBottom: '1rem', fontFamily: 'var(--font-sans)' }}>Why Vamsha?</h2>
          <p style={{ marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', marginTop: '2.5rem', marginBottom: '1rem', fontFamily: 'var(--font-sans)' }}>Getting Started</h2>
          <p style={{ marginBottom: '1.5rem' }}>
            To begin tracing your own lineage, simply <strong>Sign In</strong> using your Google Account. You can then navigate to your Dashboard to start adding entities. 
          </p>
          <p>
            Vamsha allows you to build a personal tree, safely connected to a broader, community-driven database of public and historical figures. 
          </p>
        </div>
      </div>
    </main>
